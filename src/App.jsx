      ...
      <TableHeadersProvider>
        <Router>
          <Switch>
            ...
            <Route exact path="/login" component={MemberLoginPage} />
            <Route exact path="/verify-otp" component={MemberOtpPage} />
            <Route exact path="/register" component={MemberRegisterPage} />
            <Route
              exact
              path="/forget-password"
              component={MemberForgetPasswordPage}
            />
            <Route exact path="/manage" component={MemberDrawerComponent} />
